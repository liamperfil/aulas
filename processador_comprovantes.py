import os
 ...
 def processar_pdfs():
  ...
  registrar_log(f"[ALERT] {arquivo} - O arquivo PDF tem mais de uma página. Apenas a primeira página será processada.")
  texto = reader.pages[0].extract_text() or '' # Extrai apenas a primeira página
  else:
